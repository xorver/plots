...
# legend
legend("bottomright", legend=c("Shared space read","Local space read", "Shared space write", "Local space write"), cex=0.8, col=c("black","red","blue", "green"), pch=c(1, 0, 2, 5), lty=c(2,2,2,2));
